...
# ─── Page Config ─────────────────────────────────────────────────────
st.set_page_config(
    page_title="Paletta — Color Extractor",
    page_icon="🎨",
    layout="centered",
...
st.markdown("""
<div class="hero">
    <div class="hero-eyebrow">Color Intelligence Tool</div>
    <h1>Pal<em>etta</em></h1>
...
<div class="app-footer">
    PALETTA &nbsp;·&nbsp; COLOR EXTRACTION ENGINE &nbsp;·&nbsp; POWERED BY K-MEANS
</div>
""", unsafe_allow_html=True)
